...
//   const translateY = useSharedValue(100); // start off-screen (below)
...
//               initialX={itemsPositions[item.id].x}
//               initialY={itemsPositions[item.id].y}
//               initialScale={itemsPositions[item.id].scale}
...
//           menuVisible ? { backgroundColor: "rgba(0,0,0,0.4)" } : null,
//         ]}
//         onPress={() => toggleMenu(false)}
//         pointerEvents={menuVisible ? "auto" : "none"}
//       >
//         <Animated.View style={[styles.optionsMenu, menuStyle]}>
//           <AppButton
//             type="text"
//             onPress={async () => {
//               await updateOutfit();
//             }}
//           >
//             <AppText style={{ fontSize: 25 }}>Update Cover Photo</AppText>
//           </AppButton>
//           <AppButton type="text">
//             <AppText style={{ color: Colors.light.destructive, fontSize: 25 }}>
//               Delete
//             </AppText>
//           </AppButton>
//         </Animated.View>
